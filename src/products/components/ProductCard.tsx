...
export const ProductCard = ({ product }: Props) => {
  ...
  return (
    <div className="bg-gray-800 shadow rounded-lg max-w-sm border-gray-100">
      {/* Product Image */}
      <div className="p-2">
        <Image
          width={500}
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex items-center mt-2.5 mb-5">
          {/* dynamic array with lenght raitng fill for use componet <Star/> */}
        ...
        <div className="flex items-center justify-between">
          <span className="text-2xl font-bold text-yellow-300">{`$ ${price.toFixed(
            2
          )}`}</span>
